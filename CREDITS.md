...
Original headshots, club photography, firm logos, and the preferred ATG wordmark were carried over from https://www.atgumich.com/ at the site owner’s request. `data/content.json` records the source URL for every asset. The white transparent wordmark is an original ATG asset, not a recreated logo. Optimized copies preserve the original image content.

## Stock photography

- Manhattan skyline: [Sins S on Unsplash](https://unsplash.com/photos/cityscape-near-beach-koBw3XApmc4). [Original image](https://images.unsplash.com/photo-1559222166-2646cffb40b4?auto=format&fit=crop&w=2600&q=88).
- Manhattan architecture: [Sofia Cancela on Unsplash](https://unsplash.com/photos/looking-up-at-tall-buildings-in-a-city-4u1KnDTN0DI). [Original image](https://images.unsplash.com/photo-1733937608146-7a9def68591f?auto=format&fit=crop&w=1600&q=88).

Both photographs are available under the [Unsplash License](https://unsplash.com/license). Neither is taken from the existing ATG or GIC stock photography.
...
- Technology, Media & Telecommunications: processor image supplied directly by the site owner.
- Power, Utilities & Infrastructure: [Energie-portal.sk / Unsplash](https://unsplash.com/photos/nuclear-power-plant-with-cooling-towers-emitting-steam-NjacvIB_vIQ).
- Healthcare: [Dmytro Vynohradov / Unsplash](https://unsplash.com/photos/a-microscope-sitting-on-top-of-a-white-table-xbBIJ8jLz50).
- Global Equities: [Sofia Cancela / Unsplash](https://unsplash.com/photos/looking-up-at-tall-buildings-in-a-city-4u1KnDTN0DI).
- Industrials: [Simon Kadula / Unsplash](https://unsplash.com/photos/a-factory-filled-with-lots-of-orange-machines-8gr6bObQLOI).
- Consumer & Retail: [Brett Jordan / Unsplash](https://unsplash.com/photos/a-glass-ceiling-in-a-shopping-mall-with-people-walking-around-97yKnJpF2N4).

The other five sector images use the Unsplash License. Blue/silver toning is applied in CSS; source images are preserved. Tej Prattipati’s current portrait was supplied directly for this website update.

## Additional firm marks

The Lazard wordmark comes from [Lazard’s official asset](https://s7d9.scene7.com/is/content/lazard/LazardLogoBlack?ts=1785354189578&dpr=off). The standalone name retains the original letter paths, with the Asset Management subtitle removed. Firm marks identify member and alumni employers; they do not imply sponsorship.

Additional official corporate marks: [Brookfield](https://www.brookfield.com/), [Cerberus Capital Management](https://www.cerberus.com/wp-content/themes/cerberus/assets/images/logo.svg), [BC Partners](https://www.bcpartners.com/wp-content/themes/bc-partners/assets/dist/images/svg/bc-footer-logo.svg), [BDT & MSD Partners](https://cdn.prod.website-files.com/690a39bcd7ab2972d1f443e7/6916dd3f3c2a75b9104c6b14_4ed8ccb275296da565bbd24153d8a628_bdt%26msd-logo.svg). The Brookfield header wordmark is displayed in a dark tone through CSS.
...
The requested historic [Greenhill wordmark](https://companieslogo.com/greenhill/logo/) replaces the combined Mizuho Greenhill image. The Deutsche Bank placement card uses the blue symbol-and-wordmark image supplied by the site owner as `Deutsche_Bank.jpg`. The earlier wordmark and square-and-slash assets remain archived locally.
