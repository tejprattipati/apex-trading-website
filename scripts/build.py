...
def stats():
    return '''<section id="at-a-glance" class="stats wrap" aria-label="ATG at a glance"><div><strong>60<span>+</span></strong><p>Active members</p></div><div><strong>150<span>+</span></strong><p>Alumni</p></div><div><strong>$25,000</strong><p>Assets under management</p></div><div><strong>100<span>%</span></strong><p>Full-time placement</p></div></section>'''
