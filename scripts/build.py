...
def broader_placements():
    ...
    return f'''<section class="section wrap broader-careers"><div class="section-heading"><div><p class="eyebrow">Beyond financial services</p><h2>Different paths.<br><em>Shared foundations.</em></h2></div></div><ul class="career-firms">{firms}</ul></section>'''
...
def home():
    ...
    <section class="section pillars-section"><div class="wrap"><div class="section-heading"><div><p class="eyebrow">02 / Our pillars</p><h2>More than <em>investing.</em></h2></div></div>{pillars()}</div></section>
    {gallery()}
...
def about():
    ...
    <nav class="section-nav wrap" aria-label="About sections"><a href="#executive-board">Executive board ↓</a><a href="#sector-heads">Sector heads ↓</a><a href="#chairs">Chairs ↓</a><a href="#pillars">Our pillars ↓</a></nav>
    ...
    <section id="chairs" class="section wrap"><div class="section-heading"><div><p class="eyebrow">Supporting our community</p><h2>Our <em>chairs.</em></h2></div></div>{people(chairs+advisors)}</section>
...
def prospective():
    ...
    <section class="section wrap experience-layout"><div><p class="eyebrow">The ATG experience</p><h2>Learn by doing.<br><em>Grow with others.</em></h2><p class="lead">New members join a sector team, develop investment pitches, and build a foundation in finance through our education program. Mentorship, résumé and interview preparation, and networking guidance support each step of recruiting, while club events and the New York Trek bring the experience beyond the classroom.</p></div><div class="experience-list"><p class="eyebrow">New member experience</p>{experiences}</div></section>
    <section class="section sector-grid-section" id="investment-sectors"><div class="wrap sector-grid-layout"><div class="sector-grid-intro"><p class="eyebrow light">Sector teams</p><h2>Our investment<br><em>sectors.</em></h2><p>Six investment desks. Members develop investment pitches and present them to our 60-person club. The Investment Committee votes on which ideas to add to ATG’s $25,000 long-only equity fund.</p></div><div class="sector-card-grid">{sectors}</div></div></section>
