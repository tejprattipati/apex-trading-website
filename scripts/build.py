...
def placement():
    ...
    {stats()}<section class="section wrap"><div class="section-heading"><div><p class="eyebrow">A network that stays with you</p><h2>Where our members<br><em>make their mark.</em></h2></div><p class="section-aside">Our members and alumni have worked across investment banking, investing, and financial services. Explore current and past roles across our network.</p></div>{logo_grid()}</section>
    <section class="section recent-section" id="recent-placement"><div class="wrap"><div class="section-heading"><div><p class="eyebrow">Recent placement</p><h2>Every class.<br><em>New possibilities.</em></h2></div><p class="section-aside">Explore the firms and roles<br>of our recent classes.</p></div>{tabs}{panels}</div></section>{broader_placements()}'''
